...
<html lang="en" dir="ltr">
  ...
  <body>
   ...
   <form action="search_request.php" method="get">
        <input type="text" placeholder="  Quick Search .. Book NIC" name="search">
...
<table class="my-table">
  ...
  <?php
      if(isset($_GET['search_book'])){
        ...
        $search_query="SELECT nic,username,Book_Name,Book_Id,Author,ISBN,Category,Year FROM `request_book` where nic like'%$search_book_name%'";
       ...
       while($row = mysqli_fetch_assoc($result_query))
       {
        ...
        <td>$row[Year]</td>
        <td>
            <a class='' href='issuecancel.php?id=$row[Book_Id]'>Cancel</a>
            <a class='' href='issuefunction.php?id=$row[Book_Id]'>Issue</a>
        </td>
   ...
   <!-- <tr>
      ...
      <td>Data 5</td>
      <td>Data 6</td>
      <td><button class="request-button">Issue</button>       </td>
    </tr>
    <tr>
        <td>Data 1</td>
        <td>Data 2</td>
